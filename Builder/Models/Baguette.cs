...
namespace Builder.Models
{
    public class Baguette : IComida
    {
        ...
        public Baguette(TipoPanEnum tipoPan, double costo, string nombre, string foto, TipoCarneEnum tipoCarne, List<string> ingredientes, string papas)
        {
            TipoPan = tipoPan;
            Costo = costo;
            Nombre = nombre;
        ...
        {
            return $"Baguette {Nombre} / Tipo de pan: {TipoPan}, Tipo de carne: {TipoCarne}, " +
